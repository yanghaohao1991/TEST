...
const CGFloat KJX_sectionHeight = 10.;
const CGFloat KJX_backgroundViewAlpha = 0;
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _otherTitlesFont = [UIFont systemFontOfSize:16.];
...
- (void)tableView:(UITableView *)tableView willDisplayCell:(UITableViewCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath {
    if (_titleModel && indexPath.section == 0 && indexPath.row == 0) {
        ...
        if (indexPath.section == 1 && _cancelModel) {
            ...
            if (row == 0) {
                cell.textLabel.textColor = UIColorFromHex(0x2287d6);
            }
        }
    }
}
...
- (void)tableView:(UITableView *)tableView willDisplayHeaderView:(UIView *)view forSection:(NSInteger)section {
    if (section == 1 && view
        ...
        header.contentView.backgroundColor = UIColorFromHex(0xf5f5f5 );
    }
}
